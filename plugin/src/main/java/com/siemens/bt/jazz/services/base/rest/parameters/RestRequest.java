 ...
 *
 * <p>Just a class that's easier to handle and cheap to build compared to HttServletRequest. Adds
 * the path navigation facility required for efficient routing.
 *
 * <p>All functions that handle parameters could be extracted to a separate RequestParameters class.
 */
public final class RestRequest implements Iterable<String> {
   ...
   *
   * <p>A path fragment is a part of a slash separated URL: {@code /these/are/fragments} Required
   * for navigating the path efficiently.
   *
   ...
   *
   * <p>This function is a candidate for removal in a future release.
   *
   * @return The next path fragment
   */
  ...
  /** Iterator for looping over the rest-path. {@inheritDoc} */
