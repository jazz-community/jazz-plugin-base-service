...
/**
 * Will be used to create instances of MockRequest that can be used by tests. The important point
 * here is to set the required properties so that services can access request data.
 */
